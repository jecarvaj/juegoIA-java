 ...
 * @author Ian
 */
public class PanelAbout extends JPanel implements ActionListener {
    public JButton salirBoton;
    private final JFrame principal;
    private Menu menu;
  public ImageIcon salirIcon, salirIcon2;
        public PanelAbout(JFrame principal,Menu menu){
            this.menu=menu;
    ...
    public void paintComponent(Graphics g){
        Dimension d = getSize();
        ImageIcon fondo = new ImageIcon(getClass().getResource("/botones/fondoabout.png"));        
